    ...
    <div className="max-w-5xl w-full mx-auto my-10 pt-6 pb-16">
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <section className="lg:order-first lg:row-span-2">
          <h2 className="text-4xl/tight font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl/tight">
            I am Rizky Ramadhan. I am a Blogger and Web developer.
          </h2>
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            <p>
              Hi everyone! I am Rizky Ramadhan, a blogger and programmer who is
              passionate about sharing knowledge and experiences through writing
              and coding. I believe that technology and words have the power to
            ...
            <p>
              ...
              interesting articles, programming tutorials, and personal projects
              that I work on. &quot;<i>RyzNote</i>&quot; is my personal space in
              cyberspace, where I share my thoughts, ideas, and knowledge with
              anyone who is interested.
            </p>
            <p>
              I invite you to explore &quot;
              <Button variant="link" current href="https://ryznote.vercel.app">
                RyzNote
              </Button>
              &quot; and find content that is useful to you. Feel free to leave
              comments, provide feedback, or contact me if you have questions or
              would like to collaborate. Let&apos;s learn and grow together!
            </p>
          </div>
        </section>
      </div>
